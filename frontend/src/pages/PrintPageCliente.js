...
const PrintPageCliente = () => {
  ...
  // Método 1: Impressão nativa do browser (pode guardar como PDF)
  ...
  const handleReactToPrint = useReactToPrint({
    contentRef,
    documentTitle: order ? `${order.tipo === 'orcamento' ? 'Orcamento' : 'Encomenda'}_${order.numero_encomenda}_Cliente` : 'Documento',
